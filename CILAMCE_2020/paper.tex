...
% --------------------------------------------------------------------------
The test RMSE for each model in ascending order of age was 3.31, 4.36, 4.62, 4.72, 5.94 and 5.85 respectively. The Table \ref{tab:results} presents the details and results of each model, including the naive one. The Fig. \ref{fig:results} compares the actual and predicted values for the final models.
